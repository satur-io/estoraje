...
ssh -o "StrictHostKeyChecking=no" root@${LOAD_BALANCER_PUBLIC_IP} "caddy reverse-proxy --from ${LOAD_BALANCER_PUBLIC_IP} --to ${PRIVATE_IPS[0]}:8001 --to ${PRIVATE_IPS[1]}:8001 --to ${PRIVATE_IPS[2]}:8001"
